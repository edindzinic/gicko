 ...
 *
 * COPY of src/lib/wakeBudget.ts, kept here so the deployed function bundles it. Edit the
 * original and copy it over; the reminders and the app have to predict the same times.
 */
